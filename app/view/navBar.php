<nav class="navbar navbar-expand justify-content-between fixed-top">
        <a class="navbar-brand mb-0 h1 d-none d-md-block" href="<?php echo DIRPAGE.""?>">
          <img src="<?php echo DIRIMG.'/logo.png'?>" class="navbar-brand-image d-inline-block align-top mr-2" alt="">
          AdminX
        </a>
